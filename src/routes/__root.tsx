...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "DoseLock is bedside barcode verification for Jamaican hospitals. Scan the pack. Match the order. Stop the wrong dose.",
      },
  ...
  component: () => (
    <html lang="en-JM" className="antialiased" suppressHydrationWarning>
      <head>
        <HeadContent />
      </head>
      <body>
